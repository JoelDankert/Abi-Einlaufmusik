...
ENTRIES = [
    ...
    Entry("Marijan, Manuel Löbel", "https://youtu.be/5EpyN_6dqyk?is=kz_6yUDMU8jcVR0G", "1:39"),
    ...
    Entry("Dave, Max, Erik Schwarz, Leon", "https://youtu.be/zg3CknoEDC8?is=9RLyDF9ktX7RPCyH", "0:50"),
    ...
    Entry("Felix Hafner, David, Joel", "https://youtu.be/HAfFfqiYLp0?is=rqgql9BzPs2DDj5e", "1:08"),
